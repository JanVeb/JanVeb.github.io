export default function Dandelion() {
   ...
   function maslacak() {
     ...
     function loop() {
       ...
       if (document.getElementsByClassName('dandelionAni')[0].style.display === 'none') {
   ...
   return (
    <div class="dandelionAni"
         style={{background: 'linear-gradient( to bottom, #3b66d1, #a1d3f5)',
         height: '100%',
         width: '100%',
         display: 'block',
         position: 'fixed',
